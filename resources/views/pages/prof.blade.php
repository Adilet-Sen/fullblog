                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#profile-overview"
                                   role="tab" aria-controls="home" aria-selected="true">Profile info</a>
                            </li>
                            <li class="nav-item" role="presentation">
                            ...
                            {{--                            <li class="nav-item" role="presentation">--}}
                            {{--                                <a class="nav-link" id="contact-tab" data-toggle="tab" href="#profile-settings"--}}
                            {{--                                   role="tab" aria-controls="contact" aria-selected="false">Profile settings</a>--}}
                            {{--                            </li>--}}
                            {{--                            <li class="nav-item" role="presentation">--}}
                            {{--                                <a class="nav-link" id="contact-tab" data-toggle="tab" href="#profile-change-password"--}}
                            {{--                                   role="tab" aria-controls="contact" aria-selected="false">Profile change password</a>--}}
                            {{--                            </li>--}}
                        </ul>
                                ...
                                <form action="/profile" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <img src="{{$user->getImage()}}" alt="Profile">
                                            <div class="pt-2">
                                                <input type="file" name="avatar" class="form-control"
                                                       title="Upload new profile image">
                                            </div>
                                            <div class="pt-2">
                                                <a href="/profile/avatar/destroy/{{$user->id}}"
