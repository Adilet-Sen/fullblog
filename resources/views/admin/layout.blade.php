...
<head>
    ...
    <script
        src="https://cdn.tiny.cloud/1/y2341xmnljs2ugejcq71rhrzqka9fozcymzgsyheuiq79j7x/tinymce/6/tinymce.min.js"
            ...
            <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                ...
                <li>
                    <a href="/admin/posts/create/">
                        <i class="bi bi-circle"></i><span>Craete Posts</span>
                    </a>
                </li>
            </ul>
        </li><!-- End Posts Nav -->
            ...
            <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                ...
                <li>
                    <a href="/admin/tags/create">
                        <i class="bi bi-circle"></i><span>Create Tag</span>
                    </a>
                </li>
            </ul>
        </li><!-- End Tags Nav -->
            ...
            <ul id="sub-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="/admin/subscribers/">
                        <i class="bi bi-circle"></i><span>All subs</span>
                    </a>
                </li>
                <li>
                    <a href="/admin/subscribers/create">
                        <i class="bi bi-circle"></i><span>Create sub</span>
                    </a>
                </li>
            </ul>
